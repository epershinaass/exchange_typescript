...
```bash
helm install my-release strimzi/strimzi-kafka-operator -f values.yaml
```
...
the documentation for more details. [In Development](https://strimzi.io/docs/operators/in-development/configuring.html)
